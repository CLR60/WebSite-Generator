...
<body>
	...
	<section id="templates">
		<div class="container carouTemplate">
	  		<h2 class="choix">Site vitrine  </h2>
	  ...
	  <!-- bloc a copier  -->
		...
		<div class="container carouTemplate">
	  		<h2 class="choix">Site de E-commerce  </h2>
